...
9. Recoverable Result Exhale is installed: verified omitted-result trail signs, bounded deliberate reopening, and non-respirable Roots exposure custody are active. Semantic Forest selection remains uninstalled and shadow-only under [`FOREST_EXHALE_V2.md`](specs/FOREST_EXHALE_V2.md). The provisional collector is installed and safe batches have hash-linked wake-journal custody, but they do not yet carry trace-epoch manifests joining their collector/Scrub disposition to the broader closure calendar.
