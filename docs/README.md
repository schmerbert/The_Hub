...
Start with [`ORIENTATION.md`](ORIENTATION.md). It explains the proposition, the reasons for the harness, the current shape, and the intended direction without requiring prior knowledge of Hub vocabulary.
...
| Read a feature's exact law | [`specs/`](specs/) |
...
- `STATUS.md` is the canonical current-runtime map.
- Narrow implemented specifications own their exact feature contracts.
