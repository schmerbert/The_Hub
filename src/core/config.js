...
export function readConfig(env = process.env) {
  ...
  return immutable({
    ...
    verifiedAncestryPath: env.HUB_VERIFIED_ANCESTRY_PATH || join(runtimeRoot, 'verified-ancestry.sqlite'),
...
export function resolveHubConfig(env = process.env, overrides = {}) {
  ...
  const resolved = {
    ...
    verifiedAncestryPath: overrides.verifiedAncestryPath || (dbWasSelected && !env.HUB_VERIFIED_ANCESTRY_PATH ? join(dirname(dbPath), 'verified-ancestry.sqlite') : base.verifiedAncestryPath),
